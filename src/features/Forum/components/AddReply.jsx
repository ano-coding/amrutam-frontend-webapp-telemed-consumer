...
import TrashSvg from "../../../assets/trash-1.svg?react";
  ...
  return (
    <div className="mt-5 block space-y-5 md:flex md:gap-[41px] md:space-y-0">
      ...
      <div className="flex flex-1 flex-col gap-3">
        <textarea
          rows={6}
          className="font-poppins box-border w-full rounded-[11px] border-[1px] border-solid border-[#E0E0E0] px-[14px] py-6 text-[15.2px] leading-[19.77px] text-gray-600 placeholder:text-[#7B7B7B] focus:outline-none"
          placeholder="Write your answer"
        />
        <div className={`relative ${files.length ? "hidden" : "block"}`}>
          <input
            onClick={handleButtonClick}
            className="font-poppins h-[49px] w-full cursor-pointer rounded-[11px] border-[1px] border-solid border-[#E0E0E0] px-[14px] text-[15.2px] leading-[19.77px] text-neutral-500 caret-transparent placeholder:text-[#7B7B7B] focus:outline-none disabled:bg-white"
                ...
                <Fragment>
                  ...
                  >
                    ...
                    <div className="flex w-full flex-col overflow-hidden">
                      <div className="font-poppins overflow-hidden overflow-ellipsis whitespace-nowrap text-lg font-medium tracking-[-0.01em] text-black sm:text-[20px]">
                        {file.name}
                      </div>
                      <div className="font-poppins flex gap-3 text-[16px] font-medium tracking-[-0.01em] text-[#8D8D8D]">
                        <span>1.2 MB</span>
        ...
        <div className="-mt-8 flex gap-5 self-end">
          <button
            onClick={() => setIsShowAddReply(false)}
            className="font-poppins rounded-lg border border-solid border-[#3a643b] px-4 py-2.5 text-center text-[14px] font-medium tracking-[-0.01em] text-[#3a643b] sm:w-[116px]"
          >
            Cancel
          </button>
          <button className="font-poppins rounded-lg bg-[#3a643b] px-4 py-2.5 text-center text-[14px] font-medium tracking-[-0.01em] text-white sm:w-[116px]">
            Upload
          </button>
        </div>
      </div>
