...
function ReplyPopUp({togglePopUp}) {
	...
	return ( 
		<div className='absolute -right-1 top-16 sm:right-12 sm:top-0 w-[150px] border border-[#EDEDED] rounded-xl overflow-hidden bg-white'>
			{
