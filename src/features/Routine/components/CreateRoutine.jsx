        ...
        <div className="mb-2 flex w-full flex-col gap-10 rounded-xl px-5 py-10 lg:pr-16">
          ...
          >
            ...
            <div className="flex w-full items-center justify-center gap-3 sm:gap-6">
              ...
              <button className="my-10 box-border rounded-xl bg-[#3a643b] px-16 py-[17px] text-center text-base font-semibold text-white shadow-[0px_4px_14px_rgba(58,_100,_59,_0.25)] duration-100 hover:bg-[#618a61] active:scale-95 md:w-[23.4rem]">
                Proceed
              </button>
            </div>
          </form>
