const Doctor = () => {
  return (
    <div className="relative w-[295px] rounded-[40px] bg-customWhite text-center">
      <img
        src="/doctor.png"
        alt="doctor"
        className="mx-[73px] mb-[28px] mt-[43px] h-[150px] w-[149px]"
      />
      <div className="absolute left-[38%] top-[37%] flex h-7 w-[75px] items-center justify-center gap-1 rounded-2xl bg-gradient-to-b from-lightcustomgray-200 to-lightcustomgray-100">
      ...
      <h5 className="font-inter m-0 mt-[7px] text-center text-[15px] font-medium leading-5 text-lightcustomgray-300">
      ...
      <div className="mx-auto mb-[30px] mt-[19px] flex h-[30px] w-[150px] items-center justify-center gap-1 rounded-[18px] bg-customlightgreen-200">
        <svg
          width="17"
          height="16"
          viewBox="0 0 17 16"
        ...
        <h5 className="font-nunito text-base font-semibold leading-[18px] tracking-tight text-customgreen-800">
          Skin Specialist
        </h5>
      </div>
      <div className="w-[295px] rounded-b-[40px] bg-customgreen-800 px-0 py-[23.5px] font-nunito text-xl font-semibold leading-[18px] tracking-tight text-white max-sm:text-base">
        Book a session
      </div>
    </div>
  );
