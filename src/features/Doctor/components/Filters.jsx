				...
				>
					...
					>
						<div
							...
							className="fixed inset-0 bg-gray-500 transition-opacity bg-opacity-25"
						/>
					</TransitionChild>
										...
										{({ open }) => (
											<>
												<h3 className="-mx-2 -my-3 flow-root">
													<DisclosureButton className="flex w-full items-center justify-between bg-white px-2 py-3 font-dinpro text-base text-gray-400">
												...
												<DisclosurePanel className="pt-6">
													<div className="space-y-6">
														{section.options?.map((option, optionIdx) => (
															<div
																key={option.value}
																className="flex items-center font-dinpro font-medium "
															>
																<input
						...
						<Popover.Group className="hidden space-x-6 md:flex md:items-baseline lg:space-x-8">
							{filters.map((section) => (
								...
								>
									...
									>
										<Menu.Items className="absolute max-h-[40vh] overflow-y-scroll no-scrollbar right-0 z-50 mt-2 w-44 origin-top-right rounded-md bg-white font-dinpro-medium shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
