    ...
    <div>
      ...
      <div className="mt-[74px] flex items-start justify-center gap-[26px] max-xl:flex-col max-xl:items-center max-xl:gap-0 max-sm:mt-[20px]">
        ...
        <div>
          ...
          <div className="mb-[49px] flex items-center justify-start gap-[26px] max-md:ml-5 max-sm:hidden">
            <div className="flex h-[58px] w-[262px] items-center justify-between rounded-xl border border-gray-500 px-[22px] py-0 max-xl:w-[162px] [&_svg]:cursor-pointer">
              <svg
                width="20"
                height="2"
                viewBox="0 0 20 2"
      ...
      <div className="mx-[72px] mb-[88px] mt-0 max-md:mb-0 max-sm:mx-0">
        ...
        <div className="mb-[34px] flex items-start justify-between max-lg:flex-col max-lg:items-center">
          ...
          <div className="flex items-center justify-center gap-4 max-lg:mb-5 [&_div]:flex [&_div]:h-[40px] [&_div]:w-[156px] [&_div]:items-center [&_div]:justify-center [&_div]:rounded-xl [&_div]:border [&_div]:border-gray-400 [&_span]:text-sm [&_span]:font-medium [&_span]:leading-6 [&_span]:tracking-tight [&_span]:text-customgreen-800">
            <div>
